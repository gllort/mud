...
{"db_affected_rows",F_DB_AFFECTED_ROWS,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
...
{"db_connect",F_DB_CONNECT,0,0,2,4,TYPE_NUMBER,T_STRING,T_STRING,T_STRING,T_NUMBER,250,DEFAULT_NONE},
{"db_errno",F_DB_ERRNO,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"db_error",F_DB_ERROR,0,0,1,1,TYPE_STRING,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"db_exec",F_DB_EXEC,0,0,2,2,TYPE_NUMBER,T_NUMBER,T_STRING,T_ANY,T_ANY,18,DEFAULT_NONE},
{"db_fetch",F_DB_FETCH,0,0,2,2,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_NUMBER,T_ANY,T_ANY,101,DEFAULT_NONE},
{"db_insert_id",F_DB_INSERT_ID,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
...
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,311,DEFAULT_NONE},
...
{"ed_start",F_ED_START,0,0,0,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,94,DEFAULT_NONE},
...
{"filter",F_FILTER,0,0,2,-1,TYPE_ANY,T_STRING|T_ARRAY|T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,213,DEFAULT_NONE},
{"filter_array",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_ANY,T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,202,DEFAULT_NONE},
{"filter_mapping",F_FILTER | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,215,DEFAULT_NONE},
...
{"lookat_rotate",F_LOOKAT_ROTATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,314,DEFAULT_NONE},
...
{"map",F_MAP,0,0,2,-1,TYPE_ANY,T_STRING|T_MAPPING|T_ARRAY,T_STRING|T_FUNCTION,T_ANY,T_ANY,221,DEFAULT_NONE},
...
{"map_mapping",F_MAP | F_ALIAS_FLAG,0,0,2,-1,TYPE_MAPPING,T_MAPPING,T_STRING|T_FUNCTION,T_ANY,T_ANY,215,DEFAULT_NONE},
...
{"mkpasswd",F_MKPASSWD,0,0,1,1,TYPE_STRING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"parse_my_rules",F_PARSE_MY_RULES,0,0,2,3,TYPE_ANY,T_OBJECT,T_STRING,T_NUMBER,T_ANY,330,DEFAULT_NONE},
...
{"parse_sentence",F_PARSE_SENTENCE,0,0,1,4,TYPE_ANY,T_STRING,T_NUMBER,T_ARRAY,T_MAPPING,322,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL,T_REAL,T_ANY,T_ANY,316,DEFAULT_NONE},
...
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,242,DEFAULT_NONE},
{"reset_eval_cost",F_SET_EVAL_LIMIT | F_ALIAS_FLAG,0,0,1,1,TYPE_NUMBER,T_NUMBER,T_ANY,T_ANY,T_ANY,18,0},
{"resolve",F_RESOLVE,0,0,2,2,TYPE_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_ANY,T_ANY,229,DEFAULT_NONE},
...
{"rotate_x",F_ROTATE_X,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,314,DEFAULT_NONE},
{"rotate_y",F_ROTATE_Y,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,314,DEFAULT_NONE},
{"rotate_z",F_ROTATE_Z,0,0,2,2,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_ANY,T_ANY,314,DEFAULT_NONE},
...
{"scale",F_SCALE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,314,DEFAULT_NONE},
{"set_bit",F_SET_BIT,0,0,2,2,TYPE_STRING,T_STRING,T_NUMBER,T_ANY,T_ANY,94,DEFAULT_NONE},
{"set_debug_level",F_SET_DEBUG_LEVEL,0,0,1,1,TYPE_NOVALUE,T_NUMBER|T_STRING,T_ANY,T_ANY,T_ANY,120,DEFAULT_NONE},
...
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,258,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,295,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,2,2,TYPE_STRING,T_NUMBER|T_OBJECT,T_NUMBER,T_ANY,T_ANY,306,0},
{"socket_bind",F_SOCKET_BIND,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_STRING,T_ANY,266,DEFAULT_NONE},
...
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,258,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,288,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,282,DEFAULT_NONE},
...
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,246,DEFAULT_NONE},
...
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,234,DEFAULT_NONE},
...
{"translate",F_TRANSLATE,0,0,4,4,TYPE_MOD_ARRAY|TYPE_REAL,T_ARRAY,T_REAL,T_REAL,T_REAL,314,DEFAULT_NONE},
